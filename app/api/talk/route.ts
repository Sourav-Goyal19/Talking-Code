...
export async function POST(request: NextRequest) {
    try {
        ...
        const translateToEnglish = await genAI.getGenerativeModel({ model: "gemini-pro" })
        ...
        const chatResponse = await genAI.getGenerativeModel({ model: "gemini-pro" })
        ...
        const translateToUserLang = await genAI.getGenerativeModel({ model: "gemini-pro" })
